import { formatNodes } from "./data_format/nodeGen.js";
import { makeEdgesFromWeights } from "./data_format/edgeGen.js";

export function createDense(svg, model) {

    const nodes = formatNodes(model.layers);
    const edges = makeEdgesFromWeights(model.weights);
